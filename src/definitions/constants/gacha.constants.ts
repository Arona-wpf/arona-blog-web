...
export const STARRAIL_GACHA_POOL_GROUP = {
  ...
  CHARACTER_COLLABORATION: [HonkaiStarRailGachaTypeEnum.CHARACTER_COLLABORATION_WARP],
  LIGHT_CONE_COLLABORATION: [HonkaiStarRailGachaTypeEnum.LIGHT_CONE_COLLABORATION_WARP],
